...
function 1__Initial_Setup()
{
    ...
    HTML_ADD_TITLE "${_Num_Rule} : ${_Txt_Rule}"
...
function 1.1__Filesystem_Configuation()
{
    #|# Description :  1.1 Filesystem Configuation
    #|# Var to set  : 
    #|# 				_mode                       : use this var to set the action mode between report/apply
    #|# 				${1}                        : use this var to set Base_param_Dir_To_Create        
    #|# Base usage  :  Function_Name "apply or repport"
...
function 1.1.1__Disable_Unused_filesystem()
{
