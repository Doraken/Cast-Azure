...
set_message "Info" "Filtering file : [ ${Base_Catalog_function} ] "

Filter_Base_Path_in_Cat "${Base_Catalog_function}"

set_message "Info" "Filtering file : [ ${Base_Catalog_function_depend} ] "

Filter_Base_Path_in_Cat "${Base_Catalog_function_depend}"

set_message "Info" "Filtering file : [ ${Base_Catalog_function_docs} ] "
...
set_message "Debug5" "Protected Path var is set to : [ ${Protected_PATH} ]"
