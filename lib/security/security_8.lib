...
function 8_Warning_Banners()
{
	...
	do_file_move_or_copy "${Base_Dir_Scripts_Data_Templates}/configs/banner.txt" "/etc/modt" "COPY" "1"
    do_file_move_or_copy "${Base_Dir_Scripts_Data_Templates}/configs/banner.txt" "/etc/issue" "COPY" "1"
	do_file_move_or_copy "${Base_Dir_Scripts_Data_Templates}/configs/banner.txt" "/etc/issue.net" "COPY" "1"
	chmod 644 /etc/modt
	chmod 644 /etc/issue
